...
from .forms import Input_for_Test, Formulaire_entree, Selection_entree, Checkbox_args_entree, \
    Formulaire_entree_search_metasploit, Formulaire_entree_run_metasploit
...
def metasploit_visu(request):
    ...
    if champ_de_recherche.is_valid() and champ_du_run.is_valid() and request.method == 'POST' and 'run_run' in request.POST:
        ...
        exploit_run, exploit_description, exploit_options, exploit_missing_required = main_run_exploit(exploit_wanted)
        ...
        return render(request, 'dashboard/home/metasploit_console.html',
                      {'flag_connection': flag_connection, 'list_of_exploit': list_of_exploit,
                       ...
                       'exploit_options': exploit_options, 'exploit_missing_required': exploit_missing_required, 'flag_run': flag_run})
